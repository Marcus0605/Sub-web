...
var disInterval = setInterval(displayControl,100);

//document.getElementById("tr").setAttribute("class","styleclass");
var modeBtn = document.getElementsByClassName("el-radio");
var selectMode = function(){
	if (modeBtn[0].attr("class") === "el-radio is-checked"){
		modeBtn[0].removeClass("is-checked");
		modeBtn[1].className += ' is-checked is-focused';
	} else if (modeBtn[1].attr("class") === "el-radio is-checked"){
		modeBtn[1].removeClass("is-checked");
		modeBtn[0].className += ' is-checked is-focused';
	}
  }
...
$('.shift-camera-button').click(function () {
	...
	document.getElementById("sky-container").style.height = document.getElementById("app").style.height;
...
$('.x-mark').click(function () {
	...
	document.getElementById("sky-container").style.display = "none";
	document.getElementById('app').style.cssText = "opacity:0.85";
	document.getElementById("app").style.display = "none";
