...
export default {
  data() {
    var data = {
      ...
      options: {
        ...
        customBackend: {
          "sublink后端(https://api.sublink.dev/sub?)": "https://api.sublink.dev/sub?",
        },
        backendOptions: [
        ...
        remoteConfig: [
        {
            ...
            options: [
              {
                label: "ttps://raw.githubusercontent.com/Marcus0605/GlobalInternetRules/main/SubConvert_RemoteConfig.ini",
                value:
                  "https://raw.githubusercontent.com/Marcus0605/GlobalInternetRules/main/SubConvert_RemoteConfig.ini"
              }
            ]
          },
          {
  ...
  mounted() {
    ...
    this.form.customBackend = "https://api.sublink.dev/sub?";
    this.form.remoteConfig = "https://raw.githubusercontent.com/Marcus0605/GlobalInternetRules/main/SubConvert_RemoteConfig.ini";
    this.form.excludeRemarks = "Traffic|Expire|时间|流量|中继";
